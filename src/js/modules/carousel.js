export default function carousel() {
  ...
  function initSlider(sliderblock) {
    ...
    const sliderItems = sliderblock.querySelectorAll('.slider__elem');
    //------------------------------------------------------------
    ...
    function setWidthItems() {
      console.log('fun setWidthItems()');
      const slideWidth = `${
        getWidthSlider() / getCounntVisebleItem() - calcGap()
      }px`;

      console.log(`slider Width = ${getWidthSlider()}`);
